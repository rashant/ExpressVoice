...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    for i in range(recur_layers):
        previous_layer = GRU(units, activation='relu', return_sequences=True, implementation=2, name=f'rnn_{i+1}')     (previous_layer)
...
def cnn_maxpool_bidirectional_rnn_model_dropout(input_dim, filters, kernel_size, conv_stride, units, conv_border_mode,
                                  cnn_layers=1, output_dim=29, dropout1=0.2, dropout2=0.2, pool_size=2):
    """ Build a bidirectional recurrent + convolutional with maxpooling network for speech 
    """
    # Main acoustic input
    input_data = Input(name='the_input', shape=(None, input_dim))
